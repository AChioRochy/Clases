       ...
       int cantidadFamilias = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese la cant de familias:"));
        ...
        for (int i = 0; i < cantidadFamilias; i++) {
            cantidadHijos = Integer
                    .parseInt(JOptionPane.showInputDialog(null, "Cuántos hijos tiene la familia " + (i + 1) + "?"));
            promedioEdadHijos = 0;
            ...
            System.out.println(
                    "El promedio de la edad de los hijos de la familia " + (i + 1) + " es de " + promedioEdadHijos);
        }
