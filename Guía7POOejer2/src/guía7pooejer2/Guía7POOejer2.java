...
public class Guía7POOejer2 {
    ...
    public static void main(String[] args) {
        ...
        ParDeNumerosServicios numbs = new ParDeNumerosServicios();
        
        numbs.mostrarValores();
        
        numbs.devolverMayor();
        
        System.out.println("La potencia del mayor de los numeros es: " +numbs.calcularPotencia());
               
        System.out.println("La raíz del menor de los valores es: " + numbs.calcularRaiz());
    }
